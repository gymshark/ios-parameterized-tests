...
extension FunctionUtils {
    static public func getParameters(_ function: FunctionDeclSyntax?) -> [ParameterProtocol] {
        ...
        guard let parametersList = parametersList else {
            fatalError(XCTSharkErrors.parametersAreNil.description)
        }
        
        return parametersList
    }
    
    static public func getParameter(_ function: FunctionDeclSyntax?, index: Int) -> ParameterProtocol {
        let signature = FunctionSignatureSyntax(function?.signature)
...
extension FunctionUtils {
    static public func getMacroParameters(_ function: FunctionDeclSyntax?) -> [[ParameterProtocol]] {
    ...
    static public func getMacroParameters(_ function: FunctionDeclSyntax?, index: Int) -> [ParameterProtocol] {
        let attributeList = AttributeListSyntax(function?.attributes)
