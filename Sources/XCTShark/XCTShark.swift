...
public macro InlineData(_ value: Any...) = #externalMacro(module: "XCTSharkMacros", type: "InlineDataMacro")
...
///
@attached(peer, names: arbitrary)
public macro InlineData(_ value: Any..., label: String) = #externalMacro(module: "XCTSharkMacros", type: "InlineDataMacro")
